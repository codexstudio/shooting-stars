...
public class MainMenuScreen extends Screen {
    ...
    public MainMenuScreen(Game game) {
        ...
        charatersBtn = new Button(g.getWidth() / 2, g.getHeight() * 3.5f / 5, 1.0f, 1.0f, g.newPixmap("Characters.png", Graphics.PixmapFormat.ARGB8888));
    ...
    public void update(float deltaTime) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (event.type == TouchEvent.TOUCH_UP) {
                ...
                if (charatersBtn.isVisible()) {
                    if (charatersBtn.onTouchRect(event)) {
    ...
    public void present(float deltaTime) {
        ...
        mainMenuContainer.drawContainer(g);
        optionsContainer.drawContainer(g);
        charactersContainer.drawContainer(g);
        leaderboardsContainer.drawContainer(g);
    }
